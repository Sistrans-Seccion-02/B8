...
WHERE co.fecha > '01-01-2016' AND co.fecha < '31-12-2019'
GROUP BY s.clase
...
WHERE 
    (c.valortotal BETWEEN 100000 AND 5000000) -- Rango de precio
    AND (c.fecha BETWEEN '01-01-2016' AND '31-12-2019') -- Rango de tiempo
    AND (s.clase = 'bar' OR s.nombre = 'bar'); -- Tipo o categoría de servicio
...
WHERE (c.fecha between '01-01-2016' and '31-12-2019') and u.id = 1852
GROUP BY u.nombre;
...
LEFT JOIN (
    ...
    WHERE
        c.fecha BETWEEN '01-01-2016' AND '31-12-2019'
