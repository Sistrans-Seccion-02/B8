...
public interface ServicioRepository extends JpaRepository<Servicio, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO servicios (id, capacidad, costoDanios, nombre, idHotel) VALUES ( hotelandes_sequence.nextval, :capacidad, :costoDanios, :nombre, :idHotel)", nativeQuery = true)
